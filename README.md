...
API versioning is not implemented in the current version. In a production system, all endpoints would be prefixed with /api/v1/ to allow breaking changes without affecting existing consumers.
